...
export default function InfoBox({info}){
    // let INIT_IMG = "https://images.unsplash.com/photo-1657517020109-e228d496c61c?q=80&w=1935&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
    ...
    return (
        <div className="InfoBox">
            ...
            <Card sx={{ maxWidth: 345 }}>
                ...
                {/* <p>Lorem Ipsum ksadfnsyuwebfvh alcsjkd vhurwe dcj fdgrvbsak dvhjer v vkj fhvbqefvbhevbjc vjhdjs</p> */}
                </Typography>
                </CardContent>
            </Card>
            </div>
